...
def generate_launch_description():
    ...
    turtlebot3_gazebo_share = launch_ros.substitutions.FindPackageShare(
    ...
    turtlebot3_world_path = os.path.join(turtlebot3_gazebo_share, "worlds/turtlebot3_world.world")
    ...
    declare_gazebo_world = DeclareLaunchArgument(
        "world", default_value=turtlebot3_world_path, description="Gazebo world name"
    )
    ...
    # Add a delay before launching the robot controllers
    delayed_bringup = TimerAction(
        period=5.0,  # 5 second delay to allow Gazebo to fully initialize
        actions=[
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    os.path.join(
